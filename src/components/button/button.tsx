    ...
    variants: {
      variant: {
        ...
        secondary: [
          ...
          "hover:bg-primary-200 hover:text-primary-800 hover:border-primary-400",
          "active:bg-primary-300 active:text-primary-800 active:border-primary-400",
          "disabled:bg-primary-100/50 disabled:text-primary-700/50 disabled:border-primary-300/50",
        ].join(" "),
        outline: [
          "bg-transparent text-foreground border-neutral-400",
          ...
          "disabled:border-neutral-400/50",
        ].join(" "),
        text: [
